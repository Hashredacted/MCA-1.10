...
//subtract two complex Number using structure
complex subcomplexno(complex num1, complex num2){
    complex subno;
    subno.real=num1.real-num2.real;
    subno.imaginary=num1.imaginary-num2.imaginary;
    return subno;
}
...
//Driver Code
int main(){
    cout<<"\nProgram to Get ,Display, add, subtract and Multiply Complex Number using Structure.\n\n";
    ...
    cout<<"\n\n";
    num5=subcomplexno(num1,num2);
    cout<<"The subtraction of Complex 1 and Complex 2 : \n";
    displaycomplexno(num5);
    cout<<"\n\n";
   return 0;
}
